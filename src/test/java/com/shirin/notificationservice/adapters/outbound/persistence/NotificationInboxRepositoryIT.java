...
// هدف این تست://SQLهای native داخل NotificationInboxRepository واقعاً روی Postgres واقعی درست کار
// می‌کنند
...
// دیتابیسی که از طریق Postgres Testcontainer ساخته شده و اطالاعات اون رو به spring از طریق
// DynamicPropertySource دادی رو استفاده کن
...
public class NotificationInboxRepositoryIT {
