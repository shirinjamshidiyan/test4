...
public record OrderConfirmedEventV1(
    ...
    @NotNull @PositiveOrZero @Digits(integer = 15, fraction = 2) BigDecimal totalAmount,
  ...
  public record OrderItem(
      ...
      @NotNull @PositiveOrZero @Digits(integer = 15, fraction = 2) BigDecimal unitPrice,
      @NotNull @PositiveOrZero @Digits(integer = 15, fraction = 2) BigDecimal lineTotal) {}
}
