...
Factory یعنی: “قالب ساخت این containerها”.
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderConfirmedEventV1> kafkaListenerContainerFactory(
            AppKafkaProps props,
            DefaultErrorHandler errorHandler)
    {
        // Deserializer: safe + deterministic for a single event type topic.
    //    JsonDeserializer<OrderConfirmedEventV1> deserializer = new JsonDeserializer<>(OrderConfirmedEventV1.class);
